...
// DAW - 6/7/15 - allow for case where not all of data is sent at once
long SocketClient::receive(char * buffer, int bufferlen=1024)
{

	int n = recv(this->socketfd, buffer, bufferlen, 0); //MSG_DONTWAIT);
	return n;
}
